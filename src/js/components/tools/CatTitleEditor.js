...
export default class CatTitleEditor extends Component {
	constructor(props){
		super(props);
		this.state = {
	...
	save(){
		this.props.updateCategory(this.props.element.Id, this.props.element[this.props.toUpdate], this.props.toUpdate);
	}
